...
|キュー|標準キュー|FIFOキュー|
|:---|:---|:---|
|配信|ベストエフォート<br>少なくとも１回行われる|メッセージが送信順のとおり配信<br>1回限りで確実に処理される|
...
|:---|:---|:---|
|概要|Redis(Remote dictionary Server)とはメモリ上にKey-Valueストアを構築することができるDBサーバーの一つ|分散メモリキャッシュシステムの一つ<br>DBの読み出し結果を返す|
